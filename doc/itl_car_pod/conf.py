...
ITL_CAR_POD_BASE = NRF_BASE / "doc" / "_external" / "itl_car_pod"

os.environ["ZEPHYR_BASE"] = str(ZEPHYR_BASE)
os.environ["NRF_BASE"] = str(NRF_BASE)
os.environ["ITL_LIB_BASE"] = str(ITL_LIB_BASE)
os.environ["ITL_CAR_POD_BASE"] = str(ITL_CAR_POD_BASE)
os.environ["ITL_CAR_POD_BUILD"] = str(utils.get_builddir() / "itl_car_pod")

# General ----------------------------------------------------------------------

# Import Car Pod configuration
